class AddProductComponent extends React.Component {
    ...
    render() {
        ...
        if (this.state.value != '?') {
            ...
            ShowProduct = (p) => {
                return <option key={p} value={p}>{this.state.productList.productos[this.state.value][p].name}</option>
            };
            showIngredientes = (i) => {
                if (this.state.productList.ingredientes[i].type == 'pan') {
                    return (
                        <div class="i-checks">
                            ...
                            <label htmlFor={'radio-' + i}>{this.state.productList.ingredientes[i].type}
                                - {this.state.productList.ingredientes[i].name}</label>
                        </div>
                    );
                } else 
                    return (
                        <div class="i-checks">
                            ...
                            <label htmlFor={'check-' + i}>{this.state.productList.ingredientes[i].type}
                                - {this.state.productList.ingredientes[i].name}</label>
                        </div>
                    );
                }
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        {this
                            .props
                            .ingredientsKey
                            .map(this.props.showIngredientes)}
                    </div>
                </div>
            );
        else 
